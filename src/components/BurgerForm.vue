      ...
      <form id="burger-form">
        ...
        <div class="input-container">
          ...
          <select name="acompanhamento" id="acompanhamento" v-model="acompanhamento">
            ...
            <option v-for="acompanhamento in acompanhamentos" :key="acompanhamento.id" :value="acompanhamento.tipo">{{acompanhamento.tipo}} </option>
        ...
        <div id="adicionais-container" class="input-container">
          ...
          <div v-for="adicionais in adicionaisdata" :key="adicionais.id" :value="adicionais.tipo" class="checkbox-container">
...
export default {
  ...
  methods:{
    async getIngredientes(){
      ...
      this.adicionaisdata = data.adicionaisdata
    }
  },
  mounted(){
